...
public class SanitationRequest implements Comparable<SanitationRequest> {
    ...
    private String requesterUsername;   // edu.wpi.cs3733d19.teamF.sanitation.Employee who made request
    private Timestamp requestTime;      // Request timestamp
    private String servicerUsername;    // edu.wpi.cs3733d19.teamF.sanitation.Employee who serviced request
     ...
     * @param requester edu.wpi.cs3733d19.teamF.sanitation.Employee whso made request
     */
     ...
     * @param description Textual description of request
     * @param requesterUsername edu.wpi.cs3733d19.teamF.sanitation.Employee who made request
     * @param requestTime Time request was made
     * @param servicerUsername edu.wpi.cs3733d19.teamF.sanitation.Employee who fulfilled the request
     ...
     * @param employee edu.wpi.cs3733d19.teamF.sanitation.Employee who claimed the request.
     */
    ...
    public String toString() {
        String string = "edu.wpi.cs3733d19.teamF.sanitation.SanitationRequest(" +
                "ID: " + requestID + ", " +
                "Location: " + locationID + ", " +
