/**
 * @brief Class for implementing requests requests.
 */
...
public class SanitationRequest implements Comparable<SanitationRequest> {
    ...
    /**
     * @brief Constructs new requests request without ID
    ...
    /**
     * @brief Constructs new requests request with ID
    ...
    /**
     * @brief Compares requests requests based on priority.
     */
    ...
    /**
     * @brief Converts requests request to string.
     */
